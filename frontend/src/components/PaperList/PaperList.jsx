                    ...
                    <div className="mock-pdf-container">
                      <div className="mock-pdf-page">
                        <div className="mock-pdf-header">
                          ...
                          <h3>{departments.find(d => d.id === previewPaper.department)?.name || previewPaper.department}</h3>
                        ...
                        <div className="mock-pdf-instructions">
                          <em>The figures in the margin indicate full marks for the questions.</em><br/>
                          <em>Answer any FIVE questions.</em>
                        </div>
                        <div className="mock-pdf-content">
                          <div className="mock-question">
                            <div className="q-num">1.</div>
                            <div className="q-text">Explain the fundamental concepts of {previewPaper.subject} with suitable examples. Discuss the significance of each concept in the current academic context.</div>
                            <div className="q-marks">[14]</div>
                          </div>
                          <div className="mock-question">
                            <div className="q-num">2.</div>
                            <div className="q-text">Analyze the key principles in {previewPaper.subject}. Under what conditions do these principles apply? Provide a detailed comparison.</div>
                            <div className="q-marks">[14]</div>
                          </div>
                          <div className="mock-question">
                            <div className="q-num">3.</div>
                            <div className="q-text">Write a detailed note on the practical applications of topics covered in {previewPaper.subject}. Include diagrams where applicable.</div>
                            <div className="q-marks">[14]</div>
                          </div>
                          <div className="mock-question">
                            <div className="q-num">4.</div>
                            <div className="q-text">Discuss the advanced derivations and theories associated with {previewPaper.subject}.</div>
                            <div className="q-marks">[14]</div>
                          </div>
                        </div>
                        <div className="mock-pdf-watermark">AUS PAPER VAULT</div>
                      </div>
                    </div>
                  )}
                </div>
